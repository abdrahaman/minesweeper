...
export default class Board extends React.Component {
  ...
  revealEmpty(x, y, data) {
    ...
    area.map(value => {
      if (!value.isFlagged && !value.isClicked && (value.isEmpty || !value.isMine)) {
        data[value.x][value.y].isClicked = true;
        if (value.isEmpty) {
  ...
  handleCellClick(x, y) {
    ...
    if (this.state.boardData[x][y].isClicked || this.state.boardData[x][y].isFlagged) return null;
    ...
    updatedData[x][y].isClicked = true;
  ...
  handleContextMenu(e, x, y) {
    ...
    if (updatedData[x][y].isClicked) return;
